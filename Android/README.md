...
<object data="20171020-abnd-syllabus.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="20171020-abnd-syllabus.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="20171020-abnd-syllabus.pdf">ABND Syllabus</a>.</p>
    </embed>
</object>
...
1) [Business Card App](./AndroidBasicsbyGoogleNanodegreeProgram/p1-business-card-app)

2) [Court Counter](./AndroidBasicsbyGoogleNanodegreeProgram/p2-court-counter)

3) [Quiz App](./AndroidBasicsbyGoogleNanodegreeProgram/p3-quiz-app)

4) [Musical Structure](./AndroidBasicsbyGoogleNanodegreeProgram/p4-musical-structure)

5) [Tour Guide App](./AndroidBasicsbyGoogleNanodegreeProgram/p5-tour-guide-app)

6) [News App, Stage 1](./AndroidBasicsbyGoogleNanodegreeProgram/p6-news-app-stage1)

7) [News App, Stage 2](./AndroidBasicsbyGoogleNanodegreeProgram/p7-news-app-stage2)

8) [Inventory App, Stage 1](./AndroidBasicsbyGoogleNanodegreeProgram/p8-inventory-app-stage1)

9) [Inventory App, Stage 2](./AndroidBasicsbyGoogleNanodegreeProgram/p9-inventoryApp-stage2)
